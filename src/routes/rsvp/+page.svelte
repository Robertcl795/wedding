...
<Section
	...
	subtitle="¡Únanse a nosotros para nuestro día especial! Confirmen su asistencia antes del 20 de Septiembre para informarnos si puede celebrar con nosotros. ¡Estamos ansiosos por verlos!"
	color="surface"
...
>
	<Card img="/photos/P32.jpg" reverse={false} size="lg">
		<div class="flex flex-col items-center">
			...
			<Button class="" size="xl" href={whatsappLink} target="_blank" rel="noopener noreferrer">
